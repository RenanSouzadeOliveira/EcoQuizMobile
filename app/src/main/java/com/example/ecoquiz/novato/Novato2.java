...
public class Novato2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_novato2);
    ...
    public void verificarResposta0(View v){
        ...
        if(part.validarResposta(botao.getText().toString())){
            ...
            Intent it = new Intent(Novato2.this, Novato3.class);
        ...
        try {
            ...
            btnOk.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent it = new Intent(Novato2.this, MainActivity.class);
                    startActivityForResult(it, 0);
                }
            });
            ...
            adButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (rewardedAd.isLoaded()) {
                        Activity activityContext = Novato2.this;
                        RewardedAdCallback adCallback = new RewardedAdCallback() {
                            ...
                            public void onUserEarnedReward(@NonNull RewardItem rewardItem) {
                                AlertDialog.Builder abc = new AlertDialog.Builder(Novato2.this);

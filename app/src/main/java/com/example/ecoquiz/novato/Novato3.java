...
public class Novato3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_novato3);
    ...
    public void verificarResposta0(View v){
        ...
        if(part.validarResposta(botao.getText().toString())){
            ...
            Intent it = new Intent(Novato3.this, Novato4.class);
        ...
        try {
            ...
            btnOk.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent it = new Intent(Novato3.this, MainActivity.class);
                    startActivityForResult(it, 0);
                }
            });
            ...
            adButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (rewardedAd.isLoaded()) {
                        Activity activityContext = Novato3.this;
                        RewardedAdCallback adCallback = new RewardedAdCallback() {
                            ...
                            public void onUserEarnedReward(@NonNull RewardItem rewardItem) {
                                AlertDialog.Builder abc = new AlertDialog.Builder(Novato3.this);

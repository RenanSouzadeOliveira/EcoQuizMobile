...
public class Novato6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_novato6);
    ...
    public void verificarResposta0(View v){
        ...
        if(part.validarResposta(botao.getText().toString())){
            ...
            Intent it = new Intent(Novato6.this, Novato7.class);
        ...
        try {
            ...
            btnOk.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent it = new Intent(Novato6.this, MainActivity.class);
                    startActivityForResult(it, 0);
                }
            });
            ...
            adButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (rewardedAd.isLoaded()) {
                        Activity activityContext = Novato6.this;
                        RewardedAdCallback adCallback = new RewardedAdCallback() {
                            ...
                            public void onUserEarnedReward(@NonNull RewardItem rewardItem) {
                                AlertDialog.Builder abc = new AlertDialog.Builder(Novato6.this);
